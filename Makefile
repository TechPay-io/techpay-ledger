...
ifeq ($(TARGET_NAME),TARGET_NANOX)
	ICONNAME=icons/nanox_techpay.gif
else
	ICONNAME=icons/nanos_techpay.gif
endif
...
release: all
	...
	chmod +x load.sh
	tar -zcf techpay-ledger-app-$(APPVERSION).tar.gz load.sh bin/app.hex
	rm load.sh
