#ifndef TECHPAY_LEDGER_TRANSACTION_H
#define TECHPAY_LEDGER_TRANSACTION_H
...
// txGetFormattedAmount creates human readable string representation of given int256 amount/value converted to TPC.
void txGetFormattedAmount(tx_int256_t *value, uint8_t decimals, char *out, size_t outSize);

// txGetFormattedFee calculates the transaction fee and formats it to human readable TPC value.
void txGetFormattedFee(transaction_t *tx, uint8_t decimals, char *out, size_t outSize);

#endif //TECHPAY_LEDGER_TRANSACTION_H
