#ifndef TECHPAY_LEDGER_BIP44_H
#define TECHPAY_LEDGER_BIP44_H
...
// TECHPAY_COIN_TYPE defines BIP44 coin type for TechPay/Ether (path index 1).
// This may need to be changed in the future if TechPay will opt for their own registered coin type.
static const uint32_t TECHPAY_COIN_TYPE = 60;
